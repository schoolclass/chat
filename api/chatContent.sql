...
--
-- Host: localhost
-- Generation Time: 2018-12-29 17:22:36
-- 服务器版本： 5.6.21-log
-- PHP Version: 5.5.7
...
(510, 135, 4, 'rewrewrew', '2018-12-29 16:45:46'),
(511, 135, 5, '白脸', '2018-12-29 16:52:32');
...
--
ALTER TABLE `chatContent`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '聊天信息 id', AUTO_INCREMENT=512;
COMMIT;
